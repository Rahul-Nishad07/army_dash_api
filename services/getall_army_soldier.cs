...
{
    public class getall_army_soldier
    {
        dbServices ds = new dbServices();

        public async Task<responseData> Getall_army_soldier(requestData rData)
        {
            ...
            try
            {
                ...
                var insertQuery = @"select * from pc_student.Army_soldiers";
