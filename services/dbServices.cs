...
public class dbServices{
    ...
    internal readonly object pc_student;


    public object Missions { get; internal set; }
    public object Army_mission_form { get; internal set; }
    public object Army_missionform { get; internal set; }
    public object Army_mission { get; internal set; }
    public object Army_missionform1 { get; internal set; }
    ...
    public int ExecuteInsertAndGetLastId(string sq, MySqlParameter[] prms)
{
    ...
    internal int ExecuteDeleteSQL(string query, MySqlParameter[] myParam)
    {
        throw new NotImplementedException();
    }

    internal Task<T> ExecuteSQLAsync<T>(string countQuery, object value)
    {
        throw new NotImplementedException();
    }

    internal async Task<List<List<object[]>>> executeSQL<T>(string countQuery, object value)
    {
        throw new NotImplementedException();
    }
}