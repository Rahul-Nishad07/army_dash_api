...
{
    public class getall_army_mission
    {
        dbServices ds = new dbServices();

        public async Task<responseData> Getall_army_mission(requestData rData)
        {
            ...
            try
            {
                ...
                var insertQuery = @"select * from pc_student.Army_mission";
                ...
                resData.rData["rMessage"] = allclass;
                    ...
                    resData.rData["rMessage"]="No Missions";
                }    
