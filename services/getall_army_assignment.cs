...
{
    public class getall_army_assignment
    {
        dbServices ds = new dbServices();

        public async Task<responseData> Getall_army_assignment(requestData rData)
        {
            ...
            try
            {
                ...
                var insertQuery = @"select * from pc_student.Army_Assignment";
                ...
                resData.rData["rMessage"] = allclass;
                    ...
                    resData.rData["rMessage"]="No Assignments....";
                }    
