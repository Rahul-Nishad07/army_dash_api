...
{
    public class getall_army_training
    {
        dbServices ds = new dbServices();

        public async Task<responseData> Getall_army_training(requestData rData)
        {
            ...
            try
            {
                ...
                var insertQuery = @"select * from pc_student.Army_programs";
                ...
                resData.rData["rMessage"] = allclass;
                    ...
                    resData.rData["rMessage"]="No Training Classes";
                }    
