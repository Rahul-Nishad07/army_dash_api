...
{
    public class getall_army_medicalAppointments
    {
        dbServices ds = new dbServices();

        public async Task<responseData> Getall_army_medicalAppointments(requestData rData)
        {
            ...
            try
            {
                ...
                var insertQuery = @"select * from pc_student.Army_medicalAppointment";
                ...
                resData.rData["rMessage"] = allclass;
                    ...
                    resData.rData["rMessage"]="No Appointments....";
                }    
